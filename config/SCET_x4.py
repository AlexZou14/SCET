...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            lq_folder='xxxxxx/data/DIV2K_train_LR_bicubic/X4_sub',
            gt_folder='xxxxxx/data/DIV2K_train_HR_sub',
            pipeline=train_pipeline,
            scale=scale)),
    val=dict(
        type=val_dataset_type,
        lq_folder='xxxxxxx/benchmark/validation/LR_bicubic/X4',
        gt_folder='xxxxxxx/benchmark/validation/HR',
        pipeline=test_pipeline,
        scale=scale,
        filename_tmpl='{}'),
    test=dict(
        type=val_dataset_type,
        lq_folder='xxxxx/data/LR_bicubic/X4',
        gt_folder='xxxxx/data/HR/X4',
        pipeline=test_pipeline,
        scale=scale,
        filename_tmpl='{}'))

# optimizer
optimizers = dict(generator=dict(type='Adam', lr=2e-4, betas=(0.9, 0.999), weight_decay=0.05))
